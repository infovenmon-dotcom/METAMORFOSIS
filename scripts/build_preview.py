...
js='\n'.join(read(f) for f in ['docs/assets/js/products.js','docs/assets/js/reviews.js','docs/assets/js/cart.js','docs/assets/js/app.js','docs/assets/js/motion-enhance.js','docs/assets/js/accesibilidad.js'])
js=inline_images(js)
